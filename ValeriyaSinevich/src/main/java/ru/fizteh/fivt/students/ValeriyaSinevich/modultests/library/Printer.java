...
public class Printer {
    public static void printTweet(Status tweet, ru.fizteh.fivt.students.ValeriyaSinevich.modultests.library.ParametersParser parser, boolean stream, String substring) {
        if (!substring.equals("")) {
